...
const TEXT = {
  ...
  en: {
    header: { dictionary: 'Dictionary', list: 'List', analytics: 'Analytics', quiz: 'Quiz', eikenSpeaking: 'Eiken Speaking', chat: 'AI Chat', notebook: 'Notes', trash: 'Trash', login: 'Login', logout: 'Logout', switchBook: 'Switch wordbook', language: 'Language' },
    app: {
  ...
  'zh-CN': {
    header: { dictionary: '词典', list: '列表', analytics: '分析', quiz: '测验', eikenSpeaking: '英检口语', chat: 'AI 对话', notebook: '笔记', trash: '回收站', login: '登录', logout: '退出', switchBook: '切换词书', language: '语言' },
    app: {
  ...
  ko: {
    header: { dictionary: '사전', list: '목록', analytics: '분석', quiz: '퀴즈', eikenSpeaking: '에이켄 스피킹', chat: 'AI 대화', notebook: '노트', trash: '휴지통', login: '로그인', logout: '로그아웃', switchBook: '단어장 전환', language: '언어' },
    app: {
